...
<body>
    ...
    <form action="40-JSON-Processar.php" method="GET">
        <fieldset>
            ...
            <p>
                < !-- readonly é para identificar que é chave primária-- >
                Índice &ensp;<input type="text" name="txtIndice" readonly value=" <?php echo $indice;  ?>">
            </p>

            <p>
            Código &ensp;<input type="text" name="txtCodDisciplina" value=" <?php echo $codDisciplina;  ?>">
            </p>

            <p>
                Disciplina &ensp;<input type="text" name="txtDisciplina" value=" <?php echo $disciplina;  ?>">
            </p>
